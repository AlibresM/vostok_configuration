...
- [x] Калибровка Input Shaping'а с учётом особенностей IDEX и с автоматическим построением АЧХ;
...
- [x] Калибровка Pressure Advance на обе головы за одну печать;
- [x] Индивидуальная парковка всех осей.
...
## Как откалибровать PA на обе головы сразу

1. Сгенерируйте калибровочный G-код для зеркального или повторяющего режима;
2. Включите режим одинакового PA с помощью макроса `ENABLE_EQUAL_PA`;
3. Напечатайте калибровочный G-код;
4. Выключите режим одинакового PA с помощью макроса `DISABLE_EQUAL_PA` или перезагрузив прошивку.
